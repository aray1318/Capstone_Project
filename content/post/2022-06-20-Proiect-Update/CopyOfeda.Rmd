...
```{r}
library(tidyverse)
pga_data = read_csv("/Users/aray1318/desktop/pga_tour.csv")
...
```{r}
pga2 = read_csv("/Users/aray1318/desktop/pgaTourData2.csv")
head(pga2)
